import type { Expense, ExpenseFilters } from "../services/expense.service";
...
declare const useExpenseStore: import("zustand").UseBoundStore<
  Omit<
    Omit<import("zustand").StoreApi<ExpenseState>, "setState"> & {
      setState<
        A extends
          | string
          | {
      ...
      >(
        partial:
          | ExpenseState
          | Partial<ExpenseState>
          | ((state: ExpenseState) => ExpenseState | Partial<ExpenseState>),
