                ...
                <material_1.Paper sx={{ p: { xs: 2, sm: 3 } }}>
                  ...
                  <material_1.List disablePadding>
                    <material_1.ListItem sx={{ px: { xs: 0, sm: 2 } }}>
                      <material_1.ListItemText primary="Dark Mode" secondary="Use dark theme across the application" primaryTypographyProps={{
            variant: isMobile ? 'body2' : 'body1',
        }}/>
                      <material_1.Switch />
                    </material_1.ListItem>
                    <material_1.ListItem sx={{ px: { xs: 0, sm: 2 } }}>
                      <material_1.ListItemText primary="Compact Mode" secondary="Reduce padding and margins for denser layout" primaryTypographyProps={{
            variant: isMobile ? 'body2' : 'body1',
        }}/>
                      <material_1.Switch />
                    </material_1.ListItem>
              ...
              <framer_motion_1.motion.div variants={itemAnimation}>
                <material_1.Paper sx={{ p: { xs: 2, sm: 3 } }}>
                  ...
                  <material_1.List disablePadding>
                    <material_1.ListItem sx={{ px: { xs: 0, sm: 2 } }}>
                      <material_1.ListItemText primary="Email Notifications" secondary="Receive updates and alerts via email" primaryTypographyProps={{
            variant: isMobile ? 'body2' : 'body1',
        }}/>
                      <material_1.Switch defaultChecked/>
                    </material_1.ListItem>
                    <material_1.ListItem sx={{ px: { xs: 0, sm: 2 } }}>
                      <material_1.ListItemText primary="Push Notifications" secondary="Receive instant notifications in your browser" primaryTypographyProps={{
            variant: isMobile ? 'body2' : 'body1',
        }}/>
                      <material_1.Switch defaultChecked/>
                    </material_1.ListItem>
                ...
                <material_1.Paper sx={{ p: { xs: 2, sm: 3 } }}>
                  ...
                  <material_1.Stack spacing={3}>
                    <material_1.FormControl fullWidth>
                      <material_1.InputLabel id="currency-label">Default Currency</material_1.InputLabel>
                      <material_1.Select labelId="currency-label" defaultValue="USD" label="Default Currency" size={isMobile ? 'small' : 'medium'}>
                    ...
                    <material_1.FormControl fullWidth>
                      <material_1.InputLabel id="date-format-label">Date Format</material_1.InputLabel>
                      <material_1.Select labelId="date-format-label" defaultValue="MM/DD/YYYY" label="Date Format" size={isMobile ? 'small' : 'medium'}>
