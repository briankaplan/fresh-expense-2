...
const MetricsDashboard = () => {
  ...
  if (loading) {
    return (
      <material_1.Box display="flex" justifyContent="center" alignItems="center" minHeight="80vh">
      ...
      <material_1.Grid container spacing={3}>
        ...
        <material_1.Grid item xs={12} md={4}>
          <material_1.Paper sx={{ p: 2 }}>
            ...
            <material_1.Typography variant="h4">
              ${aggregatedData?.total?.toFixed(2) || "0.00"}
            </material_1.Typography>
          </material_1.Paper>
        </material_1.Grid>
        ...
        <material_1.Grid item xs={12} md={4}>
          <material_1.Paper sx={{ p: 2 }}>
            ...
            <material_1.Typography variant="h4">
              ${aggregatedData?.average?.toFixed(2) || "0.00"}
            </material_1.Typography>
          </material_1.Paper>
        </material_1.Grid>
