        ...
        <material_1.Card sx={{
          ...
          <material_1.CardContent sx={{ p: 4 }}>
            ...
            <form onSubmit={handleSubmit}>
              <material_1.TextField fullWidth label="Email Address" type="email" value={email} onChange={e => setEmail(e.target.value)} required sx={{
            mb: 3,
            ...
            '&:disabled': {
              ...
              <material_1.Typography variant="body2" align="center">
                ...
                <material_2.Link component={react_router_dom_1.Link} to="/login" sx={{
            color: theme.palette.primary.main,
            textDecoration: 'none',
            fontWeight: 500,
            '&:hover': {
