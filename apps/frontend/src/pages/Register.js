        ...
        <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <material_1.Paper elevation={24} sx={{
            ...
            <material_1.Box component="form" onSubmit={handleSubmit} sx={{ width: '100%' }}>
              <material_1.Grid container spacing={2}>
                <material_1.Grid item xs={12} sm={6}>
                  <material_1.TextField required fullWidth name="firstName" label="First Name" value={formData.firstName} onChange={handleChange} InputProps={{
            startAdornment: (<material_1.InputAdornment position="start">
                ...
                <material_1.Grid item xs={12} sm={6}>
                  <material_1.TextField required fullWidth name="lastName" label="Last Name" value={formData.lastName} onChange={handleChange} InputProps={{
            startAdornment: (<material_1.InputAdornment position="start">
                          <icons_material_1.Person color="primary"/>
                        </material_1.InputAdornment>),
        }}/>
              ...
              <material_1.TextField margin="normal" required fullWidth name="email" label="Email Address" type="email" value={formData.email} onChange={handleChange} InputProps={{
            startAdornment: (<material_1.InputAdornment position="start">
                      <icons_material_1.Email color="primary"/>
                    </material_1.InputAdornment>),
        }} sx={{ mt: 2 }}/>

              <material_1.TextField margin="normal" required fullWidth name="companyName" label="Company Name" value={formData.companyName} onChange={handleChange} InputProps={{
            startAdornment: (<material_1.InputAdornment position="start">
                      <icons_material_1.Business color="primary"/>
                    </material_1.InputAdornment>),
        }} sx={{ mt: 2 }}/>

              <material_1.TextField margin="normal" required fullWidth name="password" label="Password" type={showPassword ? 'text' : 'password'} value={formData.password} onChange={handleChange} InputProps={{
            startAdornment: (<material_1.InputAdornment position="start">
