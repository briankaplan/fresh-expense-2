    ...
    return (<AnimatedWrapper_1.default>
      <material_1.Box sx={{ p: { xs: 2, sm: 3 } }}>
        <framer_motion_1.motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          <material_1.Grid container spacing={2} alignItems="center" sx={{
            mb: 3,
        ...
        <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.2 }}>
          <material_1.Paper sx={{
            p: { xs: 1.5, sm: 2 },
            overflowX: 'auto',
        }}>
