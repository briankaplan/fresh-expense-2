...
const ReceiptLibrary = () => {
    ...
    >
      ...
      >
        ...
        <material_1.CardActions sx={{ mt: "auto", p: 2 }}>
          ...
          {receipt.status != null && (
            <material_1.Tooltip title="Find Matches">
              <material_1.IconButton
                size="small"
                color="primary"
                onClick={(e) => {
  ...
  const ExportMenu = () => {
    ...
    return (
      <>
        <material_1.Button
          variant="outlined"
          startIcon={<icons_material_1.Save />}
  ...
  const ReceiptDialog = () => {
    ...
    const [stageSize, setStageSize] = (0, react_1.useState)({
      width: 800,
      height: 600,
    });
              ...
              <material_1.Grid container spacing={3}>
                <material_1.Grid item xs={12} md={8}>
                  ...
                  >
                    ...
                    {isAnnotating && (
                      <material_1.Box sx={{ position: "absolute", top: 8, right: 8 }}>
                  ...
                  {isAnnotating && (
                    <material_1.Box sx={{ mt: 2 }}>
                      ...
                      {annotations.map((annotation) => (
                        <material_1.Box key={annotation.id} sx={{ mb: 1 }}>
  ...
  return (
    <material_1.Box>
      ...
      {loading ? (
        <material_1.Box sx={{ display: "flex", justifyContent: "center", p: 4 }}>
          <material_1.CircularProgress />
        </material_1.Box>
      ) : (
        <material_1.Box ref={containerRef} sx={{ height: "calc(100vh - 300px)", overflow: "auto" }}>
