    ...
    return (<form onSubmit={handleSubmit}>
      <material_1.Grid container spacing={3}>
        <material_1.Grid item xs={12} sm={6}>
          <DatePicker_1.DatePicker label="Date" value={formData.date} onChange={handleDateChange} slotProps={{
            textField: {
                fullWidth: true,
                required: true,
            },
        ...
        <material_1.Grid item xs={12} sm={6}>
          <material_1.TextField name="amount" label="Amount" type="number" value={formData.amount} onChange={handleChange} fullWidth required inputProps={{
            step: '0.01',
            min: '0',
        }}/>
        </material_1.Grid>
        <material_1.Grid item xs={12}>
          <material_1.TextField name="description" label="Description" value={formData.description} onChange={handleChange} fullWidth required/>
        </material_1.Grid>
        <material_1.Grid item xs={12}>
          <material_1.FormControl fullWidth required>
            <material_1.InputLabel id="category-label">Category</material_1.InputLabel>
            <material_1.Select labelId="category-label" name="category" value={formData.category} onChange={handleChange} label="Category">
        ...
        <material_1.Grid item xs={12}>
          <material_1.TextField name="notes" label="Notes" value={formData.notes} onChange={handleChange} fullWidth multiline rows={4}/>
        </material_1.Grid>
        <material_1.Grid item xs={12}>
