    ...
    >
      ...
      >
        <material_1.Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
          {IconComponent && (
            <material_1.Box
              component={framer_motion_1.motion.div}
        ...
        <material_1.Box sx={{ display: "flex", alignItems: "baseline" }}>
          <material_1.Typography
            variant="h4"
            component={framer_motion_1.motion.h4}
          ...
          {trend && (
            ...
            >
              {trend.isPositive ? (
                <icons_1.Icons.Success.Filled fontSize="small" />
              ) : (
                <icons_1.Icons.Error.Filled fontSize="small" />
              )}
