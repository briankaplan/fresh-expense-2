      ...
      <material_1.DialogContent>
        <material_1.Box component="form" onSubmit={handleSubmit} sx={{ mt: 2 }}>
          <material_1.Box {...getRootProps()} sx={{
            ...
            <input {...getInputProps()}/>
            {preview ? (<material_1.Box component="img" src={preview} alt="Receipt preview" sx={{
                maxWidth: '100%',
                maxHeight: 200,
                objectFit: 'contain',
          ...
          <material_1.TextField fullWidth label="Merchant" value={merchant} onChange={e => setMerchant(e.target.value)} margin="normal" required/>

          <material_1.TextField fullWidth label="Amount" value={amount} onChange={e => setAmount(e.target.value)} margin="normal" required type="number" inputProps={{ step: '0.01' }}/>

          {error && (<material_1.Typography color="error" sx={{ mt: 2 }}>
              {error}
            </material_1.Typography>)}
        </material_1.Box>
      </material_1.DialogContent>
