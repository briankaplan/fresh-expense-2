      ...
      >
              ...
              <material_1.TableBody>
                {matchResults.map((match, index) => (
                  ...
                  >
                    ...
                    <material_1.TableCell>
                      ${match.existingTransaction.amount.toFixed(2)}
                    </material_1.TableCell>
                    <material_1.TableCell>
                      {match.existingTransaction.description || "-"}
                    </material_1.TableCell>
                    ...
                    <material_1.TableCell>
                      {match.csvData.receiptUrl ? (
                        <material_1.Chip label="Has Receipt" color="primary" size="small" />
                      ) : (
                        "-"
                      )}
                    </material_1.TableCell>
        ...
        <material_1.DialogActions>
          ...
          <material_1.Button
            ...
            startIcon={isLoading ? <material_1.CircularProgress size={20} /> : undefined}
          >
