...
exports.needsReview = exports.getTransactionStatusLabel = exports.categorizeTransactionType = exports.formatTransactionAmount = exports.isDuplicateTransaction = exports.mapAndValidateTellerTransaction = exports.isTellerTransaction = exports.linkReceiptToTransaction = exports.canLinkReceipt = exports.updateTransactionWithAI = exports.mapTellerToTransaction = exports.validateTransactionDate = exports.validateTransactionAmount = exports.transactionValidationRules = exports.RECEIPT_PATTERNS = exports.CATEGORY_DEFINITIONS = exports.TRANSACTION_CATEGORIES = exports.TransactionMappingError = exports.TransactionValidationError = void 0;
/**
...
const validateTransactionAmount = (amount) => {
    return (amount >= exports.transactionValidationRules.amount.min &&
...
const validateTransactionDate = (date) => {
    return (date >= exports.transactionValidationRules.date.minDate &&
...
const mapTellerToTransaction = (tellerTx, companyId, userId, aiData) => {
    return {
        ...
        category: aiData?.category.name || tellerTx.details?.category || exports.TRANSACTION_CATEGORIES.UNCATEGORIZED,
...
const isDuplicateTransaction = (transaction, existingTransactions) => {
    return existingTransactions.some(existing => existing.amount != null &&
...
const needsReview = (transaction) => {
    return (transaction.amount > 1000 || // High value transaction
