 ...
 */
export declare const mapTellerToTransaction: (tellerTx: TellerTransaction, companyId: string, userId: string, aiData?: AIProcessedData) => Partial<Transaction>;
/**
 * Updates a transaction with AI-processed data
 */
export declare const updateTransactionWithAI: (transaction: Transaction, aiData: AIProcessedData) => Transaction;
/**
 ...
 */
export declare const linkReceiptToTransaction: (transaction: Transaction, receiptId: string) => Transaction;
/**
 ...
 */
export declare const mapAndValidateTellerTransaction: (tellerTx: TellerTransaction, companyId: string, userId: string, aiData?: AIProcessedData) => Partial<Transaction>;
/**
 * Utility function to detect duplicate transactions
 */
export declare const isDuplicateTransaction: (transaction: Transaction, existingTransactions: Transaction[]) => boolean;
/**
 ...
 */
export declare const categorizeTransactionType: (transaction: Transaction) => "expense" | "income" | "transfer";
/**
