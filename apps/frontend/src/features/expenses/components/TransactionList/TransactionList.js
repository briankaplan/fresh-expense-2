...
function TransactionList({ transactions, loading, onEdit, onReceiptClick, onAICategorize }) {
  ...
  if (loading) {
    return (
      <material_1.Box display="flex" justifyContent="center" p={3}>
  ...
  if (transactions.length != null) {
    return (
      <material_1.Box p={3} textAlign="center">
      ...
      <material_1.Table>
        ...
        <material_1.TableBody>
          {transactions.map((transaction) => (
            <material_1.TableRow key={transaction.id}>
              ...
              <material_1.TableCell>
                {editing && editing.id != null && editing.field != null ? (
                  ...
                  (0, currency_utils_1.formatCurrency)(transaction.amount)
                )}
              </material_1.TableCell>
              <material_1.TableCell>
                {editing && editing.id != null && editing.field != null ? (
