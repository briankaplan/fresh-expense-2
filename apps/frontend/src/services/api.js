            ...
            if (error.response) {
                ...
                switch (status) {
                    ...
                    case 429:
                        ...
                        break;
                    case 500:
                        react_hot_toast_1.toast.error('An unexpected error occurred. Please try again later.');
                        break;
                    default:
                ...
                react_hot_toast_1.toast.error('Unable to connect to the server. Please check your internet connection.');
            }
            else {
