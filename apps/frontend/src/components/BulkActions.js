...
function BulkActions({ selectedExpenses, onDelete, onEdit, onLabel, onShare, }) {
    ...
    const handleLabel = () => {
        ...
        onLabel(selectedExpenses.map(expense => expense.id), label);
        setLabel('');
    ...
    return (<>
      ...
      <material_1.Dialog open={isLabelDialogOpen} onClose={() => setIsLabelDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <material_1.DialogContent>
          ...
          <material_1.TextField autoFocus fullWidth label="Label" value={label} onChange={e => {
