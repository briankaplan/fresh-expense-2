...
export declare function Dialog({
  ...
  direction,
  fullScreen,
}: BaseDialogProps): import("react").JSX.Element;
...
export declare function ConfirmationDialog({
  message,
  onConfirm,
  confirmText,
  cancelText,
  ...
  onClose,
  ...props
}: ConfirmationDialogProps): import("react").JSX.Element;
...
export declare function FullScreenDialog({
  onClose,
  ...props
}: FullScreenDialogProps): import("react").JSX.Element;
