...
function Dialog({ open, onClose, title, children, actions = [], maxWidth = 'sm', fullWidth = true, loading = false, showCloseButton = true, dividers = true, }) {
    ...
    return (<material_1.Dialog open={open} onClose={onClose} maxWidth={maxWidth} fullWidth={fullWidth} PaperProps={{
            sx: {
                minWidth: 300,
            },
        }}>
