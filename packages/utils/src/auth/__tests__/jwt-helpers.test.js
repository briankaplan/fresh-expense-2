...
(0, vitest_1.describe)('JWT Helpers', () => {
    ...
    (0, vitest_1.describe)('generateToken', () => {
        (0, vitest_1.it)('should generate a valid JWT token', () => {
            const token = (0, jwt_helpers_1.generateToken)({ userId: testUserId }, testSecret, { expiresIn: '1h' });
        ...
        (0, vitest_1.it)('should throw error if secret is missing', () => {
            (0, vitest_1.expect)(() => (0, jwt_helpers_1.generateToken)({ userId: testUserId }, '', { expiresIn: '1h' })).toThrow('JWT secret is required');
        });
    });
    (0, vitest_1.describe)('verifyToken', () => {
        ...
        (0, vitest_1.it)('should throw error if token is missing', () => {
            (0, vitest_1.expect)(() => (0, jwt_helpers_1.verifyToken)('', testSecret)).toThrow('Token is required');
        });
        (0, vitest_1.it)('should throw error if secret is missing', () => {
            const token = (0, jwt_helpers_1.generateToken)({ userId: testUserId }, testSecret, { expiresIn: '1h' });
            (0, vitest_1.expect)(() => (0, jwt_helpers_1.verifyToken)(token, '')).toThrow('JWT secret is required');
        });
    });
