...
describe('Schema Validation', () => {
  ...
  beforeEach(async () => {
    ...
    subscriptionModel = module.get<Model<Subscription & Document>>(getModelToken(Subscription.name));
    ...
    notificationModel = module.get<Model<Notification & Document>>(getModelToken(Notification.name));
