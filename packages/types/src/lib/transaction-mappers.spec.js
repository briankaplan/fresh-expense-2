...
(0, vitest_1.describe)("Transaction Validation and Mapping", () => {
  ...
  (0, vitest_1.describe)("Type Guards", () => {
    (0, vitest_1.it)("should correctly identify valid Transaction", () => {
      ...
      (0, vitest_1.expect)(
        (0, transaction_mappers_1.isTransaction)({
          ...validTransaction,
          id: undefined,
        }),
      ).toBe(false);
    ...
    (0, vitest_1.it)("should correctly identify valid TellerTransaction", () => {
      (0, vitest_1.expect)((0, transaction_mappers_1.isTellerTransaction)(validTellerTx)).toBe(
        true,
      );
      (0, vitest_1.expect)(
        (0, transaction_mappers_1.isTellerTransaction)({
          ...validTellerTx,
          id: undefined,
        }),
      ).toBe(false);
