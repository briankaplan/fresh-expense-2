    ...
    try {
      ...
      try {
        ...
        switch (template.format) {
          case 'pdf':
            const pdfStream = await this.pdfService.generateReport(data, template.customization);
            reportBuffer = await this.streamToBuffer(pdfStream);
            break;
          case 'csv':
